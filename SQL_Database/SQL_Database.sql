...
INSERT INTO TaiKhoan (MaTK, Username, Password, MaNV, MaVT) VALUES
('TK001', 'admin', '123123', 'nv001', 'admin'),
('TK002', 'nhanvien', '123456', 'nv002', 'nvql');
...
('KH004', N'Ngô Hoàng Long', '20', '0212252417', 'Long2154@gmail.com', N'Nam', N'Bình thạnh thành phố HCM VN','2022-08-02'),
('KH005', N'Nuyễn Xuân Hồng', '27', '0387521756', 'Hong2777@gmail.com', N'Nu', N'Quận 2 thành phố Hồ Chí Minh','2023-05-20'),
('KH006', N'Phạm Xuân Phong', '25', '0285431252', 'Phong2541@gmail.com', N'Nam', N'Bình thạnh thành phố HCM VN','2023-06-18'),
('KH007', N'Lê Thị Linh', '27', '0123456789', 'Linh2217@gmail.com', N'Nữ', N'gò vấp thành phố hồ chí minh ','2023-08-10'),
('KH008', N'Phạm Thị Anh', '18', '052173241', 'Anh2006@gmail.com', N'Nữ', N'Quận 12 thành phố hồ chí minh ','2023-05-25'),
('KH009', N'Hoàng Hữu Đức', '28', '0987654321', 'Duc1999@gmail.com', N'Nam', N'Quận 8 thành phố hồ chí minh ','2021-08-25'),
('KH010', N'Nguyễn Văn Hùng', '29', '0369258741', 'Hung1777@gmail.com', N'Nam', N'Quận 7 thành phố hồ chí minh ','2021-08-25')
-- 5t?o b?ng ??n v? tính 
CREATE TABLE DonViTinh (
    MaDVT NVARCHAR(10) NOT NULL PRIMARY KEY,
    tenDVT NVARCHAR(255) NOT NULL,
...
VALUES
    ('X12IFO4BZ', N'Hapacol 650 DHG', '24', 'thuocHapacol.png', N'Paracetamol', 'CVB123ERT', 'ZAQ321QWE', 'XCVSDF123', 1021, 20000, 25000, '2026-02-15'),
    ('XRZXFO4BZ', N'Bột pha hỗn dịch uống Smecta vị cam', '12', 'botphatieuchay.jpg', N'Diosmectite', 'CVB141ERT', 'ZXC321QWE', 'XCVSDF125', 1021, 3000, 4000, '2026-05-21'),
    ('XRBIFO4BZ', N'Siro C.C Life 100mg/5ml Foripharm', '30', 'sirocam.jpg', N'Vitamin C', 'CV123GERT', 'ZXC321QWE', 'XCVSDF123', 1032, 25000, 30000, '2026-03-01'),
    ('VFZCHLHIE', N'Panadol Extra đỏ', '64', 'Panadol-Extra.png', N'Caffeine, Paracetamol', 'CVB123ERT', 'ZAQ321QWE', 'XCVSDF122', 1034, 235000, 250000, '2026-08-07'),
    ('MJ9AB7J1I', N'Viên sủi Vitatrum C BRV', '9', 'vitaminc.png', N'Sỏi thận, Rối loạn chuyển hoá fructose, Bệnh Thalassemia, Tăng oxalat niệu, Rối loạn chuyển hoá oxalat', 'CVB123ERT', 'ZXC321QWE', 'XCVSDF122', 1076, 20000, 24000, '2027-12-31'),
    ('ESMJMM7T1', N'Bổ Gan Trường Phúc', '50', 'Bogantruongphu.jpg', N'Diệp hạ châu, Đảng Sâm, Bạch truật, Cam thảo, Phục Linh, Nhân trần, Trần bì', 'CVB123ERT', 'ZXC321QWE', 'XCVSDF123', 1034, 85000, 95000, '2026-02-15'),
    ('BV07519DS', N'Bài Thạch Trường Phúc', '6', 'bothantruongphuc.jpg', N'Xa tiền tử, Bạch mao căn, Sinh Địa, Ý Dĩ, Kim tiền thảo', 'CVB123ERT', 'ZXC321QWE', 'XCVSDF123', 1076, 85000, 95000, '2026-02-10'),
    ('798E63U16', N'Đại Tràng Trường Phúc', '32', 'Daitrangtruongphuc.jpg', N'Hoàng liên, Mộc hương, Bạch truật, Bạch thược, Ngũ bội tử, Hậu phác, Cam thảo, Xa tiền tử, Hoạt thạch', 'CVB123ERT', 'ZXC321QWE', 'XCVSDF123', 1021, 90000, 105000, '2026-09-03'),
    ('745KCI1KX', N'Ninh Tâm Vương Hồng Bàng', '46', 'Ninhtamvuong.png', N'L-Carnitine, Taurine, Đan sâm, Khổ sâm bắc, Nattokinase, Hoàng đằng, Magie, Tá dược vừa đủ', 'CVB123ERT', 'ZXC311QWE', 'XCVSDF124', 1054, 165000, 180000, '2026-08-15');
go
...
INSERT INTO nhaPhanPhoi (MaNPP, tenNPP, DienThoai, diaChi,Email)
VALUES
  ('XCZXWE123', N'Công ty Cổ phần Dược phẩm An Khang', '0283820618', N'282-284 Trần Hưng Đạo, Phường Nguyễn Cư Trinh, Quận 1, TP.HCM','nhathuocankhang@gmail.com'),
  ('23HUSZ173', N'Công ty Cổ phần Dược phẩm Pharmacity', '0243825353', N'426 Võ Văn Ngân, Phường Bình Thọ, Quận Thủ Đức, TP.HCM','cskh@pharmacity.vn'),
  ('ZXHUWE12S', N'Hệ thống nhà thuốc ECO', '0283689339', N'336 Phan Văn Trị, Phường 11, Quận Bình Thạnh, TP.HCM','eco@ecopharma.com.vn'),
  ('N4M35KL1B', N'Công ty Dược phẩm Phano', '0243574133', N'286 P. Xã Đàn, Đống Đa, Hà Nội','contact@phanopharmacy.com'),
  ('XCHUWE123', N'Công ty Dược phẩm Trung ương 2', '0243825535', '138B Đội Cấn, Ba Đình, Hà Nội','	info@phytopharma.vn'),
  ('2B32N31B2', N'Công ty Dược phẩm VCP', '0285413833', N'780 Đường Nguyễn Văn Linh, Phường Tân Phong, Quận 7, TP. Hồ Chí Minh','sale.online@vcp.com.vn');
go
...
INSERT INTO HoaDonNhap (MaHDN, MaNPP, NguoiGiao, NguoiNhan, NgayViet, NgayNhap, TongTien)
VALUES
    ('PPJ9DNBL7', 'XCZXWE123', N'Nguyễn văn Trường', N'Trần thị Kim', '2024-03-04 10:00:00', '2024-03-04 13:12:42', 10500000),
    ('RXPXRWR36', '23HUSZ173', N'Bùi Văn Nam', 'Phạm Thị Dương', '2024-03-05 09:00:00', '2024-03-05 11:31:26', 19800000),
    ('ZQKV59121', 'ZXHUWE12S', N'Hoàng Văn Tùng', N'Nguyễn Thị Thảo', '2024-03-06 06:00:00', '2024-03-06 07:18:32', 6000000),
    ('C45PX5VYN', 'XCHUWE123', N'Hoàng Trung Khánh ', N'Trần Văn Hùng', '2024-03-07 08:00:00', '2024-03-07 10:26:21', 77000000),
    ('A4B3VKX8V', 'XCHUWE123', N'Mai Thành Vũ ', N'Phạm Kim Hồng', '2024-03-11 07:00:00', '2024-03-11 08:35:37', 9500000);
GO
...
VALUES
    ('V1DFWISZ0', '2024-04-01 14:21:13', 'nv001', 'KH001', 105000),
    ('MNS6VLQ9F', '2024-04-02 16:12:51', 'nv002', 'KH002', 180000),
    ('3P06S5KGG', '2024-04-03 08:31:31', 'nv001', 'KH003', 90000),
    ('R4DDC67Q0', '2024-04-04 10:12:41', 'nv002', 'KH004', 270000),
    ('SKUQJUB5Z', '2024-04-05 12:31:36', 'nv001', 'KH005', 30000),
    ('F8BARB18Z', '2024-03-09 14:12:11', 'nv002', 'KH006', 105000),
    ('8XBLQZV9B', '2024-03-10 16:03:43', 'nv002', 'KH007', 345000),
    ('914KKABW3', '2024-03-11 08:07:32', 'nv002', 'KH008', 95000),
    ('TJ6QM5STW', '2024-03-12 10:45:11', 'nv002', 'KH009', 400000),
    ('B42SJZNIM', '2024-03-13 12:54:22', 'nv002', 'KH010', 30000),
    ('41C5TNFGE', '2024-02-14 14:14:30', 'nv002', 'KH005', 280000),
    ('ME9CL5ER6', '2024-02-15 16:15:13', 'nv002', 'KH006', 280000),
    ('WXOX8PE0Q', '2024-02-16 08:56:11', 'nv002', 'KH007', 500000),
    ('63V7R8RBE', '2024-02-17 10:18:53', 'nv001', 'KH002', 250000),
    ('1B78SGIZV', '2024-02-18 12:28:06', 'nv002', 'KH008', 105000),
    ('VBA5E001G', '2024-02-19 14:38:28', 'nv002', 'KH006', 200000),
    ('HAT7YG1MK', '2024-02-20 16:16:29', 'nv002', 'KH005', 240000),
	('ASZS32JZX', '2024-02-21 16:16:29', 'nv002', N'KH004', 135000),
	('MNXS72JXA', '2024-02-22 16:16:29', 'nv002', N'KH005', 465000);
go
